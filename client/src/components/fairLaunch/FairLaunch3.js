...
class FairLaunch3 extends Component {
	constructor(props) {
		super(props);
							...
							<div className="ant-card-body">
								...
								<form>
									...
									<ButtonToolbar>
										...
										<Link to={this.state.formValid ? '/FairLaunch4' : '#'}>
											<IconButton
...
FairLaunch3.propTypes = {
	setReduxValue1: PropTypes.func.isRequired
};
const mapStateToProps = (state) => ({
	//
});
export default connect(mapStateToProps, { setReduxValue1 })(withRouter(FairLaunch3));
